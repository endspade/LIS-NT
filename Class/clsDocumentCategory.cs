...
{
    public class clsDocumentCategory
    {
        private IConfiguration? _configuration;
        public clsDocumentCategory(IConfiguration configuration)
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        ...
                        sqlCmd.CommandText = "SP_DocumentCategory_Qry";
        ...
        public string CUD(mDocumentCategory param)
        {
            //Open connection
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        //Define the commandtype and name with parameters
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        sqlCmd.CommandText = "SP_DocumentCategory";
                        ...
                        sqlCmd.Parameters.Add(new SqlParameter("@DocType", SqlDbType.NVarChar)).Value = param.docType;
                        sqlCmd.Parameters.Add(new SqlParameter("@DocCatNumber", SqlDbType.NVarChar)).Value = param.docCatNumber;
                        sqlCmd.Parameters.Add(new SqlParameter("@DocCatDesc", SqlDbType.NVarChar)).Value = param.docCatDesc;
                        sqlCmd.Parameters.Add(new SqlParameter("@DocCatCode", SqlDbType.NVarChar)).Value = param.docCatCode;
