...
{
    public class clsProcedureManual
    {
        private IConfiguration? _configuration;
        public clsProcedureManual(IConfiguration configuration)
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        ...
                        sqlCmd.CommandText = "SP_ProcedureManual_Qry";
        ...
        public string CUD(mProcedureManual param)
        {
            //Open connection
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        //Define the commandtype and name with parameters
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        sqlCmd.CommandText = "SP_ProcedureManual";
                        ...
                        sqlCmd.Parameters.Add(new SqlParameter("@DocDesc", SqlDbType.NVarChar)).Value = param.docDesc;
                        sqlCmd.Parameters.Add(new SqlParameter("@DocRev", SqlDbType.NVarChar)).Value = param.docRev;
