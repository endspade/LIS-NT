...
namespace NGCP.LIS_NT.Class
{
    public class clsCaseStatus
    {
        ...
        public clsCaseStatus(IConfiguration configuration)
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        ...
                        sqlCmd.CommandText = "SP_CaseStatus_Qry";
        ...
        public string CUD(mCaseStatus param)
        {
            //Open connection
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        //Define the commandtype and name with parameters
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        sqlCmd.CommandText = "SP_CaseStatus";
                        ...
                        sqlCmd.Parameters.Add(new SqlParameter("@CaseStatusNumber", SqlDbType.NVarChar)).Value = param.caseStatusNumber;
                        sqlCmd.Parameters.Add(new SqlParameter("@CaseStatusDesc", SqlDbType.NVarChar)).Value = param.caseStatusDesc;
