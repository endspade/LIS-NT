...
{
    public class clsCaseLevel
    {
        private IConfiguration? _configuration;
        public clsCaseLevel(IConfiguration configuration)
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        ...
                        sqlCmd.CommandText = "SP_CaseLevel_Qry";
        ...
        public string CUD(mCaseLevel param)
        {
            //Open connection
            try
            {
                ...
                using (SqlConnection sqlConn = conn.AppConnection("LISNT"))
                {
                    ...
                    using (SqlCommand sqlCmd = sqlConn.CreateCommand())
                    {
                        //Define the commandtype and name with parameters
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        sqlCmd.CommandText = "SP_CaseLevel";
                        ...
                        sqlCmd.Parameters.Add(new SqlParameter("@CaseLevelNumber", SqlDbType.NVarChar)).Value = param.caseLevelNumber;
                        sqlCmd.Parameters.Add(new SqlParameter("@CaseLevelDesc", SqlDbType.NVarChar)).Value = param.caseLevelDesc;
